...
export const modulo2: ContenidoModulo = {
  ...
  tarea: {
    ...
    requisitos: [
      ...
      "Ponerle licencia a tu propia entrega: en la portada escribe tu nombre, el año y la licencia que elegiste. Si quieres que otros puedan reutilizarla, elige una Creative Commons con el selector oficial (creativecommons.org/choose); si no, escribe «Todos los derechos reservados». Y da crédito a cada imagen, texto o video de otra persona que uses.",
    ...
    rubrica: [
      ...
      { criterio: "Presentación, ortografía, citación de fuentes y licencia de la entrega", peso: 15 },
    ],
